...
class GUIConfigService:
    ...
    def load_config(
        ...
        """Load config for reading.

        Returns (config, resolved_path, saved_default_path).
        """
    ...
    def load_config_for_write(
        ...
        """Load config for writing.

        Returns (config, resolved_path, saved_path, existed).
        """
    ...
    def set_current_config(self, config: BenchmarkConfig, path: Path | None) -> None:
