...
DEB_ARM64_REL="${DEB_ARM64_REL:-linux_benchmark_lib/plugins/hpl/hpl_2.3-1_arm64.deb}"
DEB_AMD64_REL="${DEB_AMD64_REL:-linux_benchmark_lib/plugins/hpl/hpl_2.3-1_amd64.deb}"
...
docker buildx build --platform linux/arm64 \
  -f "${ROOT_DIR}/linux_benchmark_lib/plugins/hpl/Dockerfile.arm" \
...
docker buildx build --platform linux/amd64 \
  -f "${ROOT_DIR}/linux_benchmark_lib/plugins/hpl/Dockerfile.amd64" \
