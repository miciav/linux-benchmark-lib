...
def create_reference_config() -> BenchmarkConfig:
    ...
    fio_cfg = FIOConfig(runtime=20, rw="randrw", bs="4k", iodepth=16, numjobs=1, size="256M", directory="/tmp/lb_test_fio")
...
def test_config_snapshot(request):
    ...
    snapshot_path = Path(__file__).parent.parent / "snapshots" / "benchmark_config_snapshot.json"
