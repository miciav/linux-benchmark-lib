...
from lb_plugins.plugins.dfaas.plugin import DfaasConfig, DfaasFunctionConfig
...
def test_build_k6_script_includes_scenarios() -> None:
    ...
    script, metric_ids = build_k6_script(cfg, [("figlet", 10), ("eat-memory", 0)])
...
def test_parse_k6_summary_extracts_metrics() -> None:
    ...
    parsed = parse_k6_summary(summary, {"figlet": "fn_figlet"})
