...
def test_grafana_env_overrides(monkeypatch) -> None:
    ...
    assert cfg.grafana.url == "http://grafana.local:3000"
    assert cfg.grafana.api_key == "token"
    assert cfg.grafana.org_id == 2
