...
@patch("lb_plugins.plugins.stream.plugin.shutil.which")
...
@patch("lb_plugins.plugins.stream.plugin.subprocess.run")
@patch("lb_plugins.plugins.stream.plugin.shutil.copy2")
...
def test_compile_binary_failure(mock_run, stream_generator, tmp_path):
    ...
    with patch.object(StreamGenerator, "_upstream_stream_c", return_value=Path("/upstream/stream.c")):
        with patch("lb_plugins.plugins.stream.plugin.shutil.copy2"):
...
@patch("lb_plugins.plugins.stream.plugin.os.access")
