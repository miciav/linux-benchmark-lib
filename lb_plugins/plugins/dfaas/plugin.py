...
class DfaasPlugin(WorkloadPlugin):
    ...
    @property
    def config_cls(self) -> type[DfaasConfig]:
        return self.CONFIG_CLS

    def create_generator(self, config: DfaasConfig) -> DfaasGenerator:
        return self.GENERATOR_CLS(config)

    def get_ansible_setup_path(self) -> Path | None:
        return self.SETUP_PLAYBOOK if self.SETUP_PLAYBOOK.exists() else None
