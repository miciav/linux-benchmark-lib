...
![Class diagram](https://github.com/miciav/linux-benchmark-lib/releases/latest/download/classes.png)

## Package diagram

![Package diagram](https://github.com/miciav/linux-benchmark-lib/releases/latest/download/packages.png)
