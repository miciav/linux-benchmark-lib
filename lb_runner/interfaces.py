"""Shared interfaces and contracts for the runner system.

This module defines protocols that allow the runner and controller to interact
with external concerns (like the UI) without taking a direct dependency on them.
"""
