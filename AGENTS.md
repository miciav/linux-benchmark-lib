...
- Core modules live at the repo root: `benchmark_config.py` (config dataclasses), `controller.py` (remote controller), `data_handler.py` (aggregation), and `reporter.py` (reports/plots).
